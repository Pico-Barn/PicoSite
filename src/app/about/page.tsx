...
const VALUES = [
  ...
  { title: 'Impatto reale', body: 'Non sviluppiamo prototipi da laboratorio. Ogni sistema Pico è progettato per operare sul campo con uptime misurabile.' },
]
const TIMELINE = [
        ...
        <section className="section">
          <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)', lineHeight: '1.9', marginBottom: '1.25rem' }}>Pico nasce dall'incontro tra fisici, ingegneri e sviluppatori con un'ossessione comune: costruire strumenti che misurano, controllano e capiscono il mondo fisico meglio di qualsiasi soluzione preconfezionata.</p>
